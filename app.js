...
function answerChat(text) {
  ...
  if (lower.includes("price") || lower.includes("pricing")) {
    return "The Trader Reset is Rs. 16,999 and Elite Mentorship is Rs. 74,999. Payments are verified before portal access unlocks.";
  }
  if (lower.includes("price") || lower.includes("pricing")) {
    return "The Trader Reset is \u20B916,999 and Elite Mentorship is \u20B974,999. Payments are verified before portal access unlocks.";
  }
