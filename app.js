...
import { proceedToRazorpay, startPayment } from "./payment.js?v=20260622-icons-chat-fix";
import {
  loadPortal,
  nextLesson,
  prevLesson,
  ...
  toggleMobDrawer,
  unloadPortal
} from "./portal.js?v=20260622-icons-chat-fix";
import {
  addLesson,
  addStudent,
  addTestimonial,
  ...
  toggleTestiMedia,
  unloadAdmin
} from "./admin.js?v=20260622-icons-chat-fix";
...
function answerChat(text) {
  ...
  if (lower.includes("price") || lower.includes("pricing")) {
    return "The Trader Reset is Rs. 16,999 and Elite Mentorship is Rs. 50,000. Payments are verified before portal access unlocks.";
  }
  if (lower.includes("price") || lower.includes("pricing")) {
